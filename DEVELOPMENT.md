...
```bash
git remote add encore encore://full-stack-shopping-cart-app-vzzi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/full-stack-shopping-cart-app-vzzi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/full-stack-shopping-cart-app-vzzi/settings/integrations/github)
