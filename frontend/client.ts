...
export namespace cart {
    ...
    export class ServiceClient {
        ...
        public async add(params: RequestType<typeof api_cart_add_add>): Promise<ResponseType<typeof api_cart_add_add>> {
            ...
            const resp = await this.baseClient.callTypedAPI(`/api/cart`, {method: "POST", body: JSON.stringify(params)})
        ...
        public async get(): Promise<ResponseType<typeof api_cart_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/api/cart`, {method: "GET", body: undefined})
         ...
         */
        public async remove(params: { id: number }): Promise<void> {
            await this.baseClient.callTypedAPI(`/api/cart/${encodeURIComponent(params.id)}`, {method: "DELETE", body: undefined})
        }
        ...
        public async update(params: RequestType<typeof api_cart_update_update>): Promise<ResponseType<typeof api_cart_update_update>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/api/cart/${encodeURIComponent(params.id)}`, {method: "PUT", body: JSON.stringify(body)})
...
export namespace checkout {
    ...
    export class ServiceClient {
        ...
        public async process(params: RequestType<typeof api_checkout_process_process>): Promise<ResponseType<typeof api_checkout_process_process>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/api/checkout`, {method: "POST", body: JSON.stringify(params)})
...
export namespace product {
    ...
    export class ServiceClient {
         ...
         */
        public async list(): Promise<ResponseType<typeof api_product_list_list>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/api/products`, {method: "GET", body: undefined})
